  ...
  return el(
    ...
    [
      el('header', { className: 'vs-home__brand' }, [
        ...
        el('h2', { className: 'vs-home__headline', text: 'One ship. An uncharted frontier.' }),
        el('p', { className: 'vs-home__intro', text: 'Discover distant worlds, turn a hold of ore into a stronger ship, and bring every planet under your flag.' }),
        el('div', { className: 'vs-home__pillars' }, [
          el('p', {}, [icon('scanner'), el('span', { text: 'Explore a galaxy that wraps at every edge.' })]),
          el('p', {}, [icon('shipyard'), el('span', { text: 'Mine, trade and refit at friendly worlds.' })]),
          el('p', {}, [icon('planet'), el('span', { text: 'Win planets through influence or force.' })]),
        ]),
        el('p', { className: 'vs-home__stakes', text: 'Plan at your own pace: menus pause the galaxy. Protect your flagship — its destruction ends the campaign permanently.' }),
        el('span', {
          className: 'vs-chip',
            ...
            [
              el('div', { className: 'vs-section-heading' }, [
                el('div', {}, [
                  ...
                  el('p', { className: 'vs-muted', text: 'Your next expedition starts here.' }),
                ]),
                icon('route'),
              ]),
